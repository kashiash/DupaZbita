...
using DupaZbita.Blazor.Server.Services;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<DupaZbitaBlazorApplication>();
            ...
            builder.Modules
                ...
                .Add<DupaZbita.Module.DupaZbitaModule>()
            	.Add<DupaZbitaBlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(DupaZbita.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(DupaZbita.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            builder.AddBuildStep(application => {
                application.ApplicationName = "DupaZbita";
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "DupaZbita API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the DupaZbita.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "DupaZbita WebApi v1");
            });
        }
        else {
